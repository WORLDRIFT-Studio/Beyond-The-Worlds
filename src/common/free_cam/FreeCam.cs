// -----------------------------------------------------------------------
// <copyright file="FreeCam.cs" company="World Rift Studio">
...
public partial class FreeCam : CharacterBody3D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        Vector3 dir = (
            MainCamera3D.Transform.Basis * new Vector3(inputDir.X, moveUpDown, inputDir.Y)
        ).Normalized();

        Velocity =
            dir != Vector3.Zero
                ? Velocity.MoveToward(dir * Speed, (float)(200 * delta))
                : Velocity.MoveToward(Vector3.Zero, (float)(200 * delta));
