// -----------------------------------------------------------------------
// <copyright file="Events.cs" company="World Rift Studio">
...
/// <summary>
///     W celu dodanie nowego Eventu należy zadeklarować go poprzez [Signal] w public delegate void, gdzie nazwa powinna
///     być
///     zakończona na 'EventHandler'. Nastepnie nalezy stowrzyć metode do emitowania sygnału poprzez użycie Instance.
///     Nazwa nowej metody powinna zaczynać się od 'Emmit' a nastepnie zaweirac nazwe Eventu do którego należy (bez
///     końcówki
///     'EventHandler').
/// </summary>
